...
function sortByEmployee(key) {
    ...
    dataSet.sort((a, b) => {
        if (key === 'PersonName') {
            ...
            // Extract and convert salary values to numeric format, ensuring all formatting like commas, spaces, or symbols are removed.
            const salaryA = parseFloat(a[5].replace(/[\$,]/g, '')); // Use regex to remove $ and , globally
